...
1. Install the command line tool using one of the supported [installation](#installation) methods.
2. [Prepare your Doxygen docs](#preparing-project-doxyfile-for-docsets).
...
## GitHub Releases
Grab a prebuilt binary for a [recent release](https://github.com/chinmaygarde/doxygen2docset/releases).

## Build from Source
Build the binary yourself using [these instructions](#build).
